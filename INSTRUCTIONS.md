...
IMDb copycat: Present the actorObject with endpoint for allowing them to search by
movie’s primary title or original title. The outcome should be related
information to that title, including cast and crew.

### Requirement #2 (easy):

Top rated movies: Given a query by the actorObject, you must provide what are the top
rated movies for a genre (If the actorObject searches horror, then it should show a
...
by the actorObject, you must provide what’s the degree of separation between the person
(e.g. actorObject or actress) the actorObject has entered and Kevin Bacon. 
